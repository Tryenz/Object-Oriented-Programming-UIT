...
CVector CVector::operator+(const CVector& other) const {
    if (n != other.n) {
        cout << "[Loi] Khong the cong 2 vector khac so chieu!\n";
        return CVector(n);
    }
    CVector result(n);
    for (int i = 0; i < n; ++i) {
        result.mangdong[i] = mangdong[i] + other.mangdong[i];
    }
    return result;
}
...
CVector CVector::operator-(const CVector& other) const {
    if (n != other.n) {
        cout << "[Loi] Khong the tru 2 vector khac so chieu!\n";
        return CVector(n);
    }
    CVector result(n);
    for (int i = 0; i < n; ++i) {
...
double CVector::operator*(const CVector& other) const {
    if (n != other.n) {
        cout << "[Loi] Khong the nhan tich vo huong 2 vector khac so chieu!\n";
        return 0;
    }
    double result = 0;
    for (int i = 0; i < n; ++i) {
        result += mangdong[i] * other.mangdong[i];
    }
    return result;
}
...
CVector CVector::operator*(double k) const {
    CVector result(n);
    for (int i = 0; i < n; ++i) {
        result.mangdong[i] = mangdong[i] * k;
    }
    return result;
}
